...
const BOOKING_COLUMN_MIGRATIONS = [
  ...
  `CREATE INDEX IF NOT EXISTS media_assets_provider_object_idx ON media_assets (provider, object_key)`,
  ...
  `CREATE INDEX IF NOT EXISTS media_assets_migration_status_idx ON media_assets (migration_status)`,
  `ALTER TABLE media_assets ADD COLUMN IF NOT EXISTS legacy_object_path text NOT NULL DEFAULT ''`,
  `CREATE INDEX IF NOT EXISTS media_assets_legacy_url_idx ON media_assets (legacy_url)`,
  `CREATE INDEX IF NOT EXISTS media_assets_legacy_object_path_idx ON media_assets (legacy_object_path)`,
