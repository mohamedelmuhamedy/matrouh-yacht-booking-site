...
const DEFAULT_SETTINGS: SiteSettings = {
  ...
  card_display_name_ar: "",
  card_display_name_en: "",
  card_tagline_ar: "",
  card_tagline_en: "",
  card_bio_ar: "",
  card_bio_en: "",
  ...
  card_show_phone: "true",
  card_show_facebook: "true",
  card_show_instagram: "true",
  card_show_tiktok: "true",
  card_show_email: "true",
  card_show_website: "true",
  card_show_maps: "true",
  card_bg_type: "gradient",
  card_bg_color: "#0D1B2A",
  card_bg_gradient: "ocean",
  card_bg_image_url: "",
